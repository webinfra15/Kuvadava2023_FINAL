<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Kuvadava2023.Index" %>
            ...
            <div class="col-lg-6 align-self-center">
              <div class="owl-carousel owl-banner">
                <div class="item header-text">
                  <h6>Welcome to KUVADVA (GUJ)</h6>
                  <h2>Build <em>Machines With me </em> the best in <span>Engine</span>?</h2>
                ...
                <div class="item header-text">
                  ...
                  <p>Please <a rel="nofollow" href="#" target="_blank">support us</a> a little via PayPal if this digital marketing HTML template is useful for you. Thank you.</p>
                  <div class="down-buttons">
                    <div class="main-blue-button-hover">
  ...
  <div id="about" class="about-us section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="section-heading">
            <h2>Grow your website with our <em>Tools</em> &amp; <span>Foctory</span> Management</h2>
                ...
                <div class="col-lg-8">
                  <ul class="nacc">
                    <li class="active">
                      <div>
                        <div class="thumb">
                          <iframe width="100%" height="auto" src="https://www.youtube.com/embed/sBOMefeTg1c" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    ...
                    <li>
                      <div>
                        <div class="thumb">
                          <iframe width="100%" height="auto" src="https://www.youtube.com/embed/L0Q6cboXyLY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                          <div class="overlay-effect">
                    ...
                    <li>
                      <div>
                        <div class="thumb">
                          <iframe width="100%" height="auto" src="https://www.youtube.com/embed/sBOMefeTg1c-0Y" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                          <div class="overlay-effect">
  ...
  <div id="contact" class="contact-us section">
    <div class="container">
      <div class="row">
        <div class="col-lg-7">
          <div class="section-heading">
            <h2>Feel free to <em>Contact</em> us via the</h2>
            <div id="map">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14758.849108766433!2d70.94292438659431!3d22.36449041669574!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3959b1049f95be75%3A0x943dc6393c57e185!2sKuvadva%2C%20Gujarat%20360023!5e0!3m2!1sen!2sin!4v1702822108750!5m2!1sen!2sin" width="800" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>            </div>
            <div class="info">
      ...
      <%--  <div class="col-lg-5 align-self-center">
          <form id="contact" action="" method="get">
            <div class="row">
              ...
              <div class="col-lg-12">
                <fieldset>
                  <input type="number" name="Phone No" id="website" placeholder="Your Phone No" required="">
                </fieldset>
              </div>
              <div class="col-lg-12">
                <fieldset>
